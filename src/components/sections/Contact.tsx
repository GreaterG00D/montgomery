...
const SOCIALS = [
  {
    ...
    icon: (
      <svg width="22" height="16" viewBox="0 0 22 16" fill="none" aria-hidden="true">
        ...
        <path d="M8.8 11.42 14.6 8 8.8 4.58v6.84z" fill="#0a0a0a" />
      </svg>
    ),
  },
  {
  ...
  return (
    <section
      ...
      style={{
        ...
        background: "linear-gradient(180deg, #0a0a0a 0%, #0c0c10 100%)",
      }}
      aria-labelledby="contact-heading"
    >
      {/* Full-width entry divider */}
      <div className="absolute top-0 left-0 right-0" aria-hidden="true">
        <div style={{ height: "1px", background: "linear-gradient(90deg, transparent 0%, rgba(255,130,0,0.4) 30%, rgba(180,35,42,0.4) 70%, transparent 100%)" }} />
